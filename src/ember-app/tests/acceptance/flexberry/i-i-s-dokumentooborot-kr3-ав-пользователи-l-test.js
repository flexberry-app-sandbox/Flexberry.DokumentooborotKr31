...
moduleForAcceptance('[AGAT] Acceptance | i i s dokumentooborot kr3 ав пользователи l');

test('testing i-i-s-dokumentooborot-kr3-ав-пользователи-l', function(assert) {
