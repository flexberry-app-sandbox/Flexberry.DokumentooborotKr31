...
moduleForAcceptance('[AGAT] Acceptance | i i s dokumentooborot kr3 форма документа l');

test('testing i-i-s-dokumentooborot-kr3-форма-документа-l', function(assert) {
