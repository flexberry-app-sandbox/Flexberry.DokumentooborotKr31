...
moduleForModel('i-i-s-dokumentooborot-kr3-сотрудники', 'Unit | Serializer | i-i-s-dokumentooborot-kr3-сотрудники', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-dokumentooborot-kr3-сотрудники',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
